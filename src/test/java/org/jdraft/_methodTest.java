...
public class _methodTest extends TestCase {
    ...
    public void testNewBodyMethodsFirstForEach(){
        ...
        //verify that I 
        assertEquals( Walk.first( _m.getBody(), Expr.Classes.STRING_LITERAL), Expr.stringLiteralExpr("mr") );
        /*
        ...
        */
        assertNotNull( _m.firstAstStmt(Stmt.Classes.ASSERT));
        assertNotNull( _m.firstAstStmt(Stmt.Classes.ASSERT, a-> a.getCheck().isBinaryExpr()));
        
        assertNull( _m.firstAstStmt(Stmt.Classes.RETURN));
    ...
    public void testMethodAnonymousObjectShortcut() {
        ...
        assertNotNull( Walk.first(_m, Ast.Classes.STRING_LITERAL_EXPR));
    ...
    */
    ...
    public void testMatch(){
        ...
        System.out.println( Walk.list(_class.of(_methodTest.class),_method.class ));
    ...
    public void testMee(){
        ...
        assertTrue( _m.isType( Types.of( "void")) );
    ...
    public void testFull(){
        ...
        assertTrue( _m.isType( Types.of( "List<String>")) );
