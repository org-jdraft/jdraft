...
public class StypeParametersTest extends TestCase {
    ...
    public void testCompose(){
        ...
        assertEquals( _typeParams.of("A"), $typeParameters.of("A").draft());
        assertEquals( _typeParams.of("A,B"), $typeParameters.of("A,B").draft());
        assertEquals( _typeParams.of("A,B"), $typeParameters.of("<A,B>").draft());
        
        assertEquals( _typeParams.of(), $typeParameters.of().draft()); //any
        assertEquals( _typeParams.of(), $typeParameters.none().draft()); //none
        assertEquals( _typeParams.of("NAME"), $typeParameters.of("$name$").draft("name","NAME"));
        
    }
    
    public void testComposeParameterOverride(){
        assertEquals( _typeParams.of("A"),
             $typeParameters.none().draft("$typeParameters", _typeParams.of("A")));
    }
    ...
    public void testSelectMatch(){
        ...
        assertTrue( $typeParameters.of().matches(_typeParams.of()) );
