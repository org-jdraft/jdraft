...
public class SstmtsTest extends TestCase {
    ...
    public void testSnipAnyMatchesEmptyOrLongBlocks(){
        ...
        assertTrue( $stmts.of().matches(Statements.assertStmt("assert(1==1)")));
        assertTrue( $stmts.of().matches(Statements.breakStmt("break;")));
        assertTrue( $stmts.of().matches(Statements.assertStmt("assert(1==1)")));
    ...
    public void testFillLabelWithSingleStatement(){
        ...
        List<Statement> sts = $s.draft("body", Statements.of(()->System.out.println(1) ));
        assertEquals(2, sts.size());
        assertEquals( Statements.of( ()->{System.out.println(1);} ), sts.get(0));
        assertEquals( Statements.of( ()->System.out.println("Hello") ), sts.get(1));
    }
    ...
    public void testFillLabelWithMultipleStatements(){
        ...
        List<Statement> sts = $s.draft("body", Statements.of(()->{
    ...
    public void testDynamicLabel() {
        ...
        assertEquals(1, sts.size());
        assertEquals(Statements.of(() -> System.out.println("Hello")), sts.get(0));
    }
    ...
    public void test$snipMatchBlockComments(){
        ...
        BlockStmt bs = (BlockStmt) Statements.of( (Integer i)-> {
            /** comment 1 */
            assert 1 > 0;
            // comment 2
        ...
        assertEquals( Statements.of( ()-> {/** comment 1 */ assert 1 > 0;} ), ss.statements.get(0));
    ...
    public void test$snipSelectStaticStatement() {
        ...
        assertNotNull(s.select(Statements.of("System.out.println(1);")));
    ...
    public void test$snipSelectVarStatement() {
        ...
        assertNotNull(s.select(Statements.of("System.out.println(1);")));
        assertNotNull(s.select(Statements.of("System.out.println(1);")));
        $stmts.Select tks = s.select(Statements.of("System.out.println(1);"));
    ...
    public void test$snipSingleStmtSelect(){
        ...
        assertEquals( ss.get(0).statements.get(0), Statements.of( ()-> System.out.println(1)));
        assertEquals( ss.get(1).statements.get(0), Statements.of( ()-> System.out.println(2)));
        ...
        assertTrue( $stmt.of( Statements.of(()-> System.out.println(1) )).matches( ss.get(0).statements.get(0) ));
        assertTrue( $stmt.of( Statements.of(()-> System.out.println(2) )).matches( ss.get(1).statements.get(0)));
        assertTrue( $stmt.of( Statements.of(()-> System.out.println(3) )).matches( ss.get(2).statements.get(0)));
    ...
    public void test$snipMultiVarMultiStatement(){
        ...
        assertEquals( sts.get(0), Statements.of(()-> System.out.println(" 1 "+1)));
        assertEquals( sts.get(1), Statements.of(()-> System.out.println(" 2 "+2)));
        assertEquals( sts.get(2), Statements.of(()-> System.out.println(" 3 "+3)));
        assertEquals( sts.get(3), Statements.of(()-> System.out.println(" 4 "+4)));
    ...
    public void test$snipDecomposeStaticMultiStatements(){
        ...
        BlockStmt bs = Statements.blockStmt("{System.out.println(1); assert(true);}");
    ...
    public void test$snip(){
        ...
        assertEquals(Statements.of("System.out.println(1);"), ls.get(0));
    ...
    public void test$snipPostParameterize(){
        ...
        assertEquals( Statements.of("System.out.println(1);"), $s.fill(1).get(0));
    }

    public void test$snippetLocal(){
        assertEquals(Statements.of("System.out.println(\"Eric\");"),
                $stmts.of((Object $any$)->System.out.println($any$)).fill("\"Eric\"").get(0));
        assertEquals( Statements.of("assert(1==1);"), $stmts.of((Boolean $any$)-> {assert($any$);}).fill("1==1").get(0) );
    }
