...
public class SexTest extends TestCase {
    ...
    public void testLiteralsWithPrefix(){
        ...
        $ex<IntegerLiteralExpr, _intExpr, $ex> $one = $ex.intLiteralEx("1");
        $ex<IntegerLiteralExpr, _intExpr, $ex> $hex = $ex.intLiteralEx("0x01");
        $ex<IntegerLiteralExpr, _intExpr, $ex> $bin = $ex.intLiteralEx("0b01");
        $ex<IntegerLiteralExpr, _intExpr, $ex> $Hex = $ex.intLiteralEx("0X01");
        $ex<IntegerLiteralExpr, _intExpr, $ex> $Bin = $ex.intLiteralEx("0B01");
    ...
    public void testFloatAndDouble(){
        ...
        $ex<DoubleLiteralExpr, _doubleExpr, $ex> d = $ex.of( new DoubleLiteralExpr("3.14") );
        $ex<DoubleLiteralExpr, _doubleExpr, $ex> dd = $ex.of( new DoubleLiteralExpr("3.14d") );
        $ex<DoubleLiteralExpr, _doubleExpr, $ex> dD = $ex.of( new DoubleLiteralExpr("3.14D"));
        ...
        $ex<DoubleLiteralExpr, _doubleExpr, $ex> f = $ex.of( new DoubleLiteralExpr("3.14") );
        $ex<DoubleLiteralExpr, _doubleExpr, $ex> fd = $ex.of( new DoubleLiteralExpr("3.14f") );
        $ex<DoubleLiteralExpr, _doubleExpr, $ex> fD = $ex.of( new DoubleLiteralExpr("3.14F"));
    ...
    public void testSelect(){
        $ex<IntegerLiteralExpr, _intExpr, $ex> e = $ex.intLiteralEx("1").$("1", "val");
        ...
        List<$ex.Select<IntegerLiteralExpr, _intExpr>> sel =  e.listSelectedIn( _class.of(C.class) );
