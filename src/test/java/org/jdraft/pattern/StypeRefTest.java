...
public class StypeRefTest extends TestCase {
    ...
    public void testType(){
        ...
        assertEquals( _annos.of("@NotNull"), _t.getAnnoExprs() );
    ...
    public void testFindAllTypeReferences(){
        ...
        List<MethodCallExpr> ms = Walk.list(_c, Ast.Classes.METHOD_CALL_EXPR );
        ...
        Walk.in(_c, Ast.Classes.FIELD_ACCESS_EXPR, mc -> {
        ...
        System.out.println("FOUND FIELDS + " + Walk.in(_c, Ast.Classes.FIELD_ACCESS_EXPR, f-> f.toString().equals( "draft.java.proto.$typeRefTest.OldT" ) ) );
        System.out.println("FOUND FIELDS + " + Walk.in(_c, Ast.Classes.FIELD_ACCESS_EXPR, f-> f.toString().equals( "OldT" ) ) );
        System.out.println("FOUND METHODS 1+ " + Walk.in(_c, Ast.Classes.METHOD_CALL_EXPR, m-> m.toString().equals( "draft.java.proto.$typeRefTest.OldT" ) ) );
        
        Walk.in( _c, Ast.Classes.METHOD_CALL_EXPR, mc -> mc.getScope().isPresent() && mc.getScope().get().toString().equals("draft.java.proto.$typeRefTest.OldT"),
        ...
        System.out.println(Walk.list(_c, Ast.Classes.FIELD_ACCESS_EXPR, f->{
