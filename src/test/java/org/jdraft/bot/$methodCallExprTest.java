...
public class $methodCallExprTest extends TestCase {
    ...
    public void testName(){
        ...
        assertTrue( $mc.matches(Expr.methodCallExpr(()-> "eric".split("a"))) );
        assertFalse( $mc.matches(Expr.methodCallExpr(()-> System.out.println("a"))) );
    ...
    public void testScope(){
        ...
        assertTrue( $mc.matches(Expr.methodCallExpr(()-> "eric".split("a"))) );
        assertTrue( $mc.matches(Expr.methodCallExpr(()-> System.out.println("a"))) );

        //scope that is a specific string
        $mc.$scope("\"eric\"");
        assertTrue( $mc.matches(Expr.methodCallExpr(()-> "eric".split("a"))) );
        assertFalse( $mc.matches(Expr.methodCallExpr(()-> "deric".split("a"))) );
        ...
        assertTrue( $mc.matches(Expr.methodCallExpr(()-> "eric".split("a"))) );
        assertTrue( $mc.matches(Expr.methodCallExpr(()-> mc().split("a"))) );
        assertFalse( $mc.matches(Expr.methodCallExpr(()-> System.out.println("a"))) );
        ...
        assertTrue( $mc.matches(Expr.methodCallExpr(()-> "eric".split("a"))) );
        assertTrue( $mc.matches(Expr.methodCallExpr(()-> System.out.println("a"))) );
        assertFalse( $mc.matches( Expr.methodCallExpr( ()-> mc())));
