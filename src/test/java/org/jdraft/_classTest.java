...
public class _classTest extends TestCase {
   ...
   interface MemberI{ }
    ...
    public void testImplementInferImports(){
        _class _c = _class.of("C").addToBody(new ChumbaWomba(){
            URI u = null;
            @Override
    ...
    public void testImplement(){
        _class _c = _class.of("C").addToBody(new MyI(){
            public void m(){
...
//            });
    ...
    public void testStaticClassLambdaAuto(){
        ...
        System.out.println( _c.getConstructor(0).getBody() );
        System.out.println( _c.getConstructor(0).getBody().getAstStatement(0) );
         assertTrue( _c.getConstructor(0).getBody().getAstStatement(0).equals( Stmt.of("this.name = name;") ) );
    }
