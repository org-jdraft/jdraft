...
public class _diffApiTest extends TestCase {
    ...
    public void testDiffLeftOnly(){
        ...
        assertEquals(_dn, _d.at(Feature.INNER_TYPE, "", _class.class, "Inner", _field.class, "g", _anno.class, "Deprecated"));
        assertEquals(_dn, _d.at(_nodePath.of(Feature.INNER_TYPE, "", _class.class, "Inner", _field.class, "g", _anno.class, "Deprecated")));
    ...
    */
    public void testEdit(){
        ...
        _method m = (_method)_a.getInnerType("Inner").getMember( _method.class );
