...
public class IsTest extends TestCase {
    ...
    public void testIsAny(){
        ...
        assertTrue(_anno.of("@A").is("$any$"));
        assertTrue(_annos.of("@A @B").is("$any$"));
        ...
        assertTrue(_annoEntryPair.of("k=1").is("$any$"));
        assertTrue(_annoEntryPair.of("12345").is("$any$"));
    ...
    public void testIsNode(){
        ...
        assertTrue(_anno.of("@A(1)").is("@A($any$)"));

        assertTrue(_anno.of("@A($any$)").isSingleMember());
        assertTrue(_anno.of("@A($any$)").getEntryPair(0).isValueOnly());
        assertTrue(_anno.of("@A").is("@A($any$)"));


        //exactMatch
        assertTrue(_annos.of("@A @B").is("@A @B"));
        //out of order matching
        assertTrue(_annos.of("@A @B").is("@B @A"));

        //no overlap
        assertFalse( _annos.of("@A @B").is("@C"));
        //extract doesnt match
        assertFalse( _annos.of("@A @B").is("@A @B @C"));

        //one of matching
        assertTrue(_annos.of("@A @B").is("@A"));
        assertTrue(_annos.of("@A @B").is("@B"));

        //wildcard matching (& out of order)
        assertTrue(_annos.of("@A @B").is("@$any$ @B"));
        assertTrue(_annos.of("@A @B").is("@$any$ @A"));
