...
public class GoogleErrorProne_AndroidTest extends TestCase {
    ...
    public void testInjectAfterSuper() {
        ...
        $annoRef $SUPPRESS_WARNING_ANNO = $annoRef.of("@SuppressWarnings(\"AndroidInjectionBeforeSuper\")");
        ...
        $method.of().forEachIn( _suppressed, m -> m.addAnnoExprs( $SUPPRESS_WARNING_ANNO.draft()));
