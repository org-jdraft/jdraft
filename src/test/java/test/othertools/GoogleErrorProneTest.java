...
public class GoogleErrorProneTest extends TestCase {
    ...
    public void testFindReturnsNullsIfNotAnnotatedWithNullable(){
        ...
        assertTrue( $returnNull.firstIn(FFF.class)
                .node().stream(Node.TreeTraversal.PARENTS).anyMatch(p-> $method.of().$name("name").match(p) ) );
    ...
    public void testMultiTierQuery(){
        ...
        _project _cc =
                _project.of(_FAIL_InFragment, _FAIL_InjBeforeSuperInBetween, _FAIL_InjectBeforeSuperActivity);
