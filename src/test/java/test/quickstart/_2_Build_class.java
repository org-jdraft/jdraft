 ...
 */
public class _2_Build_class extends TestCase {

    public void testModelForThisClass(){
        // create a _class (_c) model for the java source of this runtime Class(_2_Quickstart)
        _class _c = _class.of( _2_Build_class.class );

        // we can get properties of the _class (_c) similar to Reflection
        assertEquals( _2_Build_class.class.getSimpleName(), _c.getName() );
        assertEquals( _2_Build_class.class.getCanonicalName(), _c.getFullName() );
        assertEquals( _2_Build_class.class.getPackage().getName(), _c.getPackageName() );
