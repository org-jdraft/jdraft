 ...
 * @author Eric
 */
public final class _mods implements _nodeList<Modifier, _mod, _mods> {

    private final NodeWithModifiers node;

    public static _mods of(NodeWithModifiers nm ) {
        return new _mods( nm );
    }

    public static _mods of() {
        return new _mods();
    }
    ...
    //this will handle
    public static _mods of(String... mods ) {
        _mods _ms = new _mods();
    ...
    public _mods copy(){
        return _mods.of( this.node );
    }

    public static _mods of(List<Modifier> mods){
        _mods _ms = new _mods();
    ...
    public static _mods of(Modifier... mods ) {
        _mods _ms = new _mods();
    ...
    public _mods(NodeWithModifiers nm ) {
        this.node = nm;
    }
    ...
    public _mods set(String... keywords ) {
        Arrays.stream( keywords ).forEach( kw -> set( kw ) );
        return this;
    }

    public _mods set(String keyword ) {
    ...
    public _mods unset(String keyword ) {
        Modifier m = Ast.MODS_KEYWORD_TO_ENUM_MAP.get( keyword );
        if( m == null ) {
            throw new IllegalArgumentException( "invalid modifier keyword \"" + keyword + "\"" );
        }
    ...
    public _mods set(Modifier.Keyword keyword ) {
    ...
    public _mods unset(Modifier mod ) {
    ...
    @Override
    public List<_mod> listElements() {
        List<_mod> mods = new ArrayList<>();
        this.node.getModifiers().forEach(m -> mods.add( _mod.of((Modifier)m)) );
        return mods;
    }
    ...
    public interface _hasModifiers<_HM extends _hasModifiers>
         ...
         * @return
         */
        default _HM modifiers(_mods mods) {
            return replace( mods );
        }

        default _HM replace(_mods _ms) {
