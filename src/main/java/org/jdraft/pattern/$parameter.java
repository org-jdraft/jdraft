 ...
 * @author Eric
 */
public final class $parameter implements Template<_parameter>, $pattern<_parameter, $parameter>, $pattern.$java<_parameter,$parameter>,
     ...
     */
    @Override
    public _parameter firstIn( _meta_model _j){
