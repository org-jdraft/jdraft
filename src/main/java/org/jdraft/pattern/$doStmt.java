...
public class $doStmt extends $stmt<DoStmt, _doStmt> {
    ...
    public static <A extends Object, B extends Object, C extends Object, D extends Object> $doStmt of( Expr.TriFunction<A,B,C,D> command ){
        return from(Expr.lambdaExpr( Thread.currentThread().getStackTrace()[2]));
    }

    public static <A extends Object, B extends Object, C extends Object, D extends Object, E extends Object> $doStmt of( Expr.QuadFunction<A,B,C,D,E> command ){
        return from(Expr.lambdaExpr( Thread.currentThread().getStackTrace()[2]));
    }
