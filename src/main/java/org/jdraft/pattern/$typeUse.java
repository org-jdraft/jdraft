...
public final class $typeUse {
    ...
    public <_N extends _java._compoundNode> _N removeIn(_N _n ) {
        ...
        removeIn( ((_java._compoundNode)_n).ast() );
        return _n;
    }
    ...
    public <_N extends _java._compoundNode> List<Node> listIn(_N _node ){
