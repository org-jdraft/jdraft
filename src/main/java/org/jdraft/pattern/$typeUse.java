...
public final class $typeUse {
    ...
    public <_N extends _java._multiPart> _N removeIn(_N _n ) {
        ...
        removeIn( ((_java._multiPart)_n).ast() );
        return _n;
    }
    ...
    public <_N extends _java._multiPart> List<Node> listIn(_N _node ){
    ...
    public <N extends Node> List<Node> listIn( N astRootNode ){
        ...
        Collections.sort(uniqueSels, At.COMPARE_NODE_BY_POSITION);
