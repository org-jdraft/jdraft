...
public final class $typeUse {
    ...
    public <_J extends _model> _J replaceIn(_J _j, Class replacement) {
    ...
    public <_J extends _model> _J replaceIn(_J _j, String replacement) {
        if( _j instanceof _code ){
            if( ((_code) _j).isTopLevel()){
                replaceIn( ((_code) _j).astCompilationUnit(), replacement);
                return _j;
    ...
    public <_J extends _model> _J replaceIn(_J _j, Node replacement) {
        if( _j instanceof _code ){
            if( ((_code) _j).isTopLevel()){
                replaceIn( ((_code) _j).astCompilationUnit(), replacement);
                return _j;
    ...
    public <_J extends _model> _J forEachIn(_J _j, Consumer<Node> nodeActionFn ) {
    ...
    public <_J extends _model> _J forSelectedIn(_J _j, Consumer<$node.Select> selectActionFn ) {
    ...
    public <_J extends _model> _J forSelectedIn(_J _j, Predicate<$node.Select> selectConstraint, Consumer<$node.Select> selectActionFn ) {
    ...
    public <_J extends _model> List<$node.Select> listSelectedIn(_J _j){
        List<$node.Select> sels = new ArrayList<>();
    ...
    public <_J extends _model> List<$node.Select> listSelectedIn(_J _j, Predicate<$node.Select> selectConstraint){
        List<$node.Select> sels = new ArrayList<>();
