...
public class $node implements $pattern<Node, $node>, $body.$part, $method.$part, $constructor.$part {
    ...
    public boolean match(_java._domain _j){
        if( _j instanceof _java._compoundNode){
            return match( ((_java._compoundNode)_j).ast());
        }
        return false;
    }
    ...
    */
    ...
    public <_J extends _java._domain> _J replaceIn(_J _j, $node $replacement) {
        ...
        replaceIn( ((_java._compoundNode) _j).ast(), $replacement);
        return _j;
    }
    ...
    public <_CP extends _compilationUnit._provider> _CP replaceIn(_CP codeProvider, String replacement ){
    ...
    public <_J extends _java._domain> _J forSelectedIn(_J _j, Consumer<Select> nodeActionFn) {
        ...
        forSelectedIn( ((_java._compoundNode) _j).ast(), nodeActionFn);
        return _j;
    }
