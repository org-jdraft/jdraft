...
public class $parameters implements Template<_parameters>, $pattern<_parameters,$parameters>,
     ...
     * @return 
     */
    public <_J extends _mrJava> _J replaceIn(_J _j, String...parametersPattern ) {
     ...
     * @return 
     */
    public <_J extends _mrJava> _J replaceIn(_J _j, $parameters $replacementProto) {
     ...
     * @return 
     */
    public <_J extends _mrJava> _J forSelectedIn(_J _j, Consumer<Select> _parametersActionFn) {
     ...
     * @return 
     */
    public <_J extends _mrJava> _J forSelectedIn(_J _j, Predicate<Select> selectConstraint, Consumer<Select> _parametersActionFn) {
        Walk.in(_j, _parameters.class, n-> {
            Select sel = select( n );
            if( sel != null && selectConstraint.test(sel) ){
                _parametersActionFn.accept(sel);            
