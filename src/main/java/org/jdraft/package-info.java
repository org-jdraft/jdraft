/**
 * jdraft Represents for Java source code as _draft Object implementations.
 ...
 *</PRE>
 * 
 * <P>with jdraft, the developer gets a new representation of Java source code...
 * In addition to being able to manipulate the code as plain text in files, 
 * the source code can be created or loaded as a _draft domain object and
 ...
 * 
 * <P>..the _draft domain object representing the source does NOT exist in the
 ...
 * astCoid.implements( Serializable.class)
 * </PRE>
 * 
