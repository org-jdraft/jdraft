...
public interface _expr<E extends Expression, _E extends _expr>
    ...
    class Impl {
        ...
        public static Class<_doubleExpr> DOUBLE_EXPR = _doubleExpr.class;
     ...
     * @see _textBlockExpr
     */
    interface _literal<NE extends Expression, _NE extends _expr & _tree._node> extends _expr<NE, _NE>,
            _tree._node<NE, _NE> {
