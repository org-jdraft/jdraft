 ...
 * @author Eric
 */
public final class _enumDiff implements _differ<_enum, _tree._node> {
    ...
    @Override
    public <_PN extends _tree._node> _diff diff(_nodePath path, _build dt, _PN _leftParent, _PN _rightParent, _enum left, _enum right) {
        ...
        _annosDiff.INSTANCE.diff(path, dt, left, right, left.getAnnoExprs(), right.getAnnoExprs());
    ...
    public static class _enumConstantDiff
            implements _differ<_constant, _tree._node> {
        ...
        @Override
        public <_PN extends _tree._node> _diff diff(_nodePath path, _build dt, _PN _leftParent, _PN _rightParent, _constant left, _constant right) {

            _nodePath _p = path.in(CONSTANT, left.getName());

            _annosDiff.INSTANCE.diff(_p, dt, left, right, left.getAnnoExprs(), right.getAnnoExprs());
    ...
    public static class _enumConstantsDiff
            implements _differ<List<_constant>, _tree._node> {
        ...
        @Override
        public <_PN extends _tree._node> _diff diff(_nodePath path, _build dt, _PN _leftParent, _PN _rightParent, List<_constant> left, List<_constant> right) {
            Set<_constant> ls = new HashSet<>();
            Set<_constant> rs = new HashSet<>();
    ...
    public static class ArgsInspect implements _differ<List<_expr>, _tree._node> {
        ...
        public <_PN extends _tree._node> _diff diff(_nodePath path, _build dt, _PN _leftParent, _PN _rightParent, List<_expr> left, List<_expr> right) {
