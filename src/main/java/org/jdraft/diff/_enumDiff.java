 ...
 * @author Eric
 */
public class _enumDiff implements _differ<_enum, _java._compound> {
    ...
    @Override
    public <_PN extends _java._compound> _diff diff(_nodePath path, _build dt, _PN _leftParent, _PN _rightParent, _enum left, _enum right) {
    ...
    public static class _enumConstantDiff
            implements _differ<_constant, _java._compound> {
        ...
        @Override
        public <_PN extends _java._compound> _diff diff(_nodePath path, _build dt, _PN _leftParent, _PN _rightParent, _constant left, _constant right) {
    ...
    public static class _enumConstantsDiff
            implements _differ<List<_constant>, _java._compound> {
        ...
        @Override
        public <_PN extends _java._compound> _diff diff(_nodePath path, _build dt, _PN _leftParent, _PN _rightParent, List<_constant> left, List<_constant> right) {
            Set<_constant> ls = new HashSet<>();
            Set<_constant> rs = new HashSet<>();
    ...
    public static class ArgsInspect implements _differ<List<Expression>, _java._compound> {
        ...
        @Override
        public <_PN extends _java._compound> _diff diff(_nodePath path, _build dt, _PN _leftParent, _PN _rightParent, List<Expression> left, List<Expression> right) {
