 ...
 * @author Eric
 */
public class _enumDiff implements _differ<_enum, _java._node> {
    ...
    public static class ArgsInspect implements _differ<List<Expression>, _java._node> {
        ...
        @Override
        public <_PN extends _java._node> _diff diff(_nodePath path, _build dt, _PN _leftParent, _PN _rightParent, List<Expression> left, List<Expression> right) {
