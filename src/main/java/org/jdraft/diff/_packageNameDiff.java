...
public final class _packageNameDiff
        implements _differ<String, _tree._node> {
    ...
    @Override
    public <_PN extends _tree._node> _diff diff(_nodePath path, _build dt, _PN _leftParent, _PN _rightParent, String leftPackageName, String rightPackageName) {
