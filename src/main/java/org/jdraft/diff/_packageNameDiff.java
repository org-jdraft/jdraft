...
public class _packageNameDiff
        implements _differ<String, _java._compound> {
    ...
    @Override
    public <_PN extends _java._compound> _diff diff(_nodePath path, _build dt, _PN _leftParent, _PN _rightParent, String leftPackageName, String rightPackageName) {
