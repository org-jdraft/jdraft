...
public interface _diff {
    ...
    default _diffNode on(Class<? extends _java._compound> clazz){
        return first( d-> d.on(clazz));
    }
    
    default _diffNode on(Class<? extends _java._compound> clazz, String id){
    ...
    default <_N extends _java._compound> _diffNode leftOnlyAt(Class<_N> nodeClass){
        return first(d -> d.isLeftOnly() && d.at(Component.of(nodeClass)));
    }
    
    default <_N extends _java._compound> _diffNode leftOnlyAt(Class<_N> nodeClass, String id){
    ...
    default <_N extends _java._compound> _diffNode leftOnlyOn(Class<_N> nodeClass){
    ...
    default <_N extends _java._compound>_diffNode leftOnlyOn(Class<_N> nodeClass, String id){
    ...
    default <_N extends _java._compound> _diffNode rightOnlyAt(Class<_N> nodeClass){
        return first(d -> d.isRightOnly() && d.at(Component.of(nodeClass)));
    }
    
    default <_N extends _java._compound> _diffNode rightOnlyAt(Class<_N> nodeClass, String id){
    ...
    default <_N extends _java._compound> _diffNode rightOnlyOn(Class<_N> nodeClass){
    ...
    default <_N extends _java._compound>_diffNode rightOnlyOn(Class<_N> nodeClass, String id){
    ...
    default <_N extends _java._compound> _diffNode changeAt(Class<_N> nodeClass){
    ...
    default <_N extends _java._compound> _diffNode changeAt(Class<_N> nodeClass, String id){
    ...
    default <_N extends _java._compound> _diffNode changeOn(Class<_N> nodeClass){
    ...
    default <_N extends _java._compound>_diffNode changeOn(Class<_N> nodeClass, String id){
     ...
     * @return
     */
    default <_N extends _java._compound> _diffNode editAt(Class<_N> nodeClass){
     ...
     * @return
     */
    default <_N extends _java._compound> _diffNode editAt(Class<_N> nodeClass, String id){
     ...
     * @return
     */
    default <_N extends _java._compound> _diffNode editOn(Class<_N> nodeClass){
     ...
     * @return
     */
    default <_N extends _java._compound>_diffNode editOn(Class<_N> nodeClass, String id){
     ...
     * @return 
     */
    default <_N extends _java._compound> boolean isAt(Class<_N> c ){
     ...
     * @return true if a Diff was found at this Node, false otherwise
     */
    default <_N extends _java._compound> boolean isAt(Class<_N>node, String id) {
     ...
     * @return 
     */
    default <_N extends _java._compound> boolean isOn(Class<_N> c ){
     ...
     * @return true if a Diff was found at this Node, false otherwise
     */
    default <_N extends _java._compound> boolean isOn(Class<_N>node, String id) {
     ...
     * @return
     */
    default <_N extends _java._compound> boolean hasRightOnlyAt(Class<_N> memClass) {
     ...
     * @return
     */
    default <_N extends _java._compound> boolean hasLeftOnlyAt(Class<_N> memClass) {
     ...
     * @return
     */
    default <_N extends _java._compound> boolean hasChangeAt(Class<_N> memClass) {
     ...
     * @return
     */
    default <_N extends _java._compound> boolean hasEditAt(Class<_N> memClass) {
     ...
     * @return
     */
    default <_N extends _java._compound> boolean hasRightOnlyAt(Class<_N> memClass, String id) {
     ...
     * @return
     */
    default <_N extends _java._compound> boolean hasLeftOnlyAt(Class<_N> memClass, String id) {
     ...
     * @return
     */
    default <_N extends _java._compound> boolean hasChangeAt(Class<_N> memClass, String id) {
     ...
     * @return
     */
    default <_N extends _java._compound> boolean hasEditAt(Class<_N> memClass, String id) {
        return hasRightOnlyAt( Component.of(memClass) ,id); 
    }
     ...
     * @return
     */
    default <_N extends _java._compound> boolean hasRightOnlyOn(Class<_N> memClass) {
     ...
     * @return
     */
    default <_N extends _java._compound> boolean hasLeftOnlyOn(Class<_N> memClass) {
     ...
     * @return
     */
    default <_N extends _java._compound> boolean hasChangeOn(Class<_N> memClass) {
     ...
     * @return
     */
    default <_N extends _java._compound> boolean hasEditOn(Class<_N> memClass) {
     ...
     * @return
     */
    default <_N extends _java._compound> boolean hasRightOnlyOn(Class<_N> memClass, String id) {
     ...
     * @return
     */
    default <_N extends _java._compound> boolean hasLeftOnlyOn(Class<_N> memClass, String id) {
     ...
     * @return
     */
    default <_N extends _java._compound> boolean hasChangeOn(Class<_N> memClass, String id) {
     ...
     * @return
     */
    default <_N extends _java._compound> boolean hasEditOn(Class<_N> memClass, String id) {
     ...
     * @return
     */
    default <_N extends _java._compound> _diffNode firstOn(Class<_N> nodeClass) {
     ...
     * @return
     */
    default <_N extends _java._compound> _diffNode firstOn(Class<_N> nodeClass, String id) {
     ...
     * @return
     */
    default <_N extends _java._compound> _diffNode firstAt(Class<_N> nodeClass) {
     ...
     * @return
     */
    default <_N extends _java._compound> _diffNode firstAt(Class<_N> nodeClass, String id) {
     ...
     * @return
     */
    default <_N extends _java._compound> List<_diffNode> listAt(Class<_N> nodeClass) {
     ...
     * @return
     */
    default <_N extends _java._compound> List<_diffNode> listAt(Class<_N> nodeClass, String id) {
     ...
     * @return
     */
    default <_N extends _java._compound> List<_diffNode> listOn(Class<_N> nodeClass) {
     ...
     * @return
     */
    default <_N extends _java._compound> List<_diffNode> listOn(Class<_N> nodeClass, String id) {
     ...
     */
    class _diffList<_RN extends _java._compound>
     ...
     */
    interface _differ<T, _RN extends _java._compound> {
        ...
        default _diff diff(T left, T right) {
            ...
            if( left instanceof _java._compound && right instanceof _java._compound) {
                md = new _diffList((_java._compound)left, (_java._compound) right);
            } else{
         ...
         */
        <_PN extends _java._compound> _diff diff(_nodePath path, _build ds, _PN _leftParent, _PN _rightParent, T left, T right);
    }
