...
public final class _importsDiff
    ...
    public <_PN extends _java._multiPart> _diff diff(_nodePath path, _build dt, _PN leftParent, _PN rightParent, _imports left, _imports right) {
        return diff( path, dt, leftParent, rightParent, left.astCompilationUnit.getImports(), right.astCompilationUnit.getImports() );
    }
    
    @Override
    public <_PN extends _java._multiPart> _diff diff(_nodePath path, _build dt, _PN _leftParent, _PN _rightParent, List<ImportDeclaration> left, List<ImportDeclaration> right) {
        Set<ImportDeclaration> ls = new HashSet<>();
        Set<ImportDeclaration> rs = new HashSet<>();
