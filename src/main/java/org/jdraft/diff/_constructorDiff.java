...
public class _constructorDiff implements _differ<_constructor, _java._compound> {
    ...
    @Override
    public <_PN extends _java._compound> _diff diff(_nodePath path, _build dt, _PN _leftParent, _PN _rightParent, _constructor left, _constructor right) {
