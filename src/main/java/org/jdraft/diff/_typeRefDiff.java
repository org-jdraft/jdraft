...
public class _typeRefDiff
    implements _differ<_typeRef, _java._compound> {
    
    public static final _typeRefDiff INSTANCE = new _typeRefDiff();

    @Override
    public <_PN extends _java._compound> _diff diff(_nodePath path, _build dt, _PN _leftParent, _PN _rightParent, _typeRef left, _typeRef right) {
