...
public final class _modifiersDiff implements
        _differ<NodeList<Modifier>, _tree._node> {
    ...
    @Override
    public <_PN extends _tree._node> _diff diff(_nodePath path, _build dt, _PN _leftParent, _PN _rightParent, NodeList<Modifier> left, NodeList<Modifier> right) {
