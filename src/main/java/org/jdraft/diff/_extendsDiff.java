...
public final class _extendsDiff implements
        _differ<List<ClassOrInterfaceType>, _tree._node> {
    ...
    @Override
    public <_PN extends _tree._node> _diff diff(_nodePath path, _build dt, _PN _leftParent, _PN _rightParent, List<ClassOrInterfaceType> left, List<ClassOrInterfaceType> right) {
