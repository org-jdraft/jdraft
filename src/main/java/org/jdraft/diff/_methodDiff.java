...
public class _methodDiff implements _differ<_method, _java._compound> {
    ...
    @Override
    public <_PN extends _java._compound> _diff diff(_nodePath path, _build dt, _PN _leftParent, _PN _rightParent, _method left, _method right) {
