...
public class _bodyDiff
        implements _differ<_body, _java._compoundNode> {
    ...
    @Override
    public <_PN extends _java._compoundNode> _diff diff(_nodePath path, _build ds, _PN _leftParent, _PN _rightParent, _body left, _body right) {
        if (left == right) {
            return (_diff) ds;
        }
