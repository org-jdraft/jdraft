...
public class diff_match_patch {
  ...
  protected LinkedList<Diff> diff_bisect(String text1, String text2,
    ...
    for (int d = 0; d < max_d; d++) {
      ...
      // _walk the reverse path one step.
  ...
  private String diff_linesToCharsMunge(String text, List<String> lineArray,
    ...
    // _walk the text, pulling out a substring for each line.
    ...
    while (thisDiff != null) {
      if (thisDiff.operation == Operation.EQUAL) {
        ...
        if (lastEquality != null && (lastEquality.length()
          ...
          // _walk back to offending equality.
      ...
      if (prevDiff.operation == Operation.EQUAL &&
        ...
        if (!prevDiff.text.equals(bestEquality1)) {
          ...
          if (bestEquality1.length() != 0) {
            ...
            pointer.previous(); // _walk past nextDiff.
            pointer.previous(); // _walk past thisDiff.
            pointer.previous(); // _walk past prevDiff.
            pointer.remove(); // Delete prevDiff.
            pointer.next(); // _walk past thisDiff.
            pointer.next(); // _walk past nextDiff.
          }
    ...
    while (nextDiff != null) {
      if (prevDiff.operation == Operation.EQUAL &&
        ...
        if (thisDiff.text.endsWith(prevDiff.text)) {
          ...
          pointer.remove(); // Delete prevDiff.
          pointer.next(); // _walk past thisDiff.
          thisDiff = pointer.next(); // _walk past nextDiff.
          nextDiff = pointer.hasNext() ? pointer.next() : null;
          changes = true;
